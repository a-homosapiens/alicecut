...
export const EXIT_EFFECTS: EffectPreset[] = [
  ...
  },
  {
    ...
    apply({ enterT, unitIndex, intensity }) {
      ...
      return { dx: side * (1 - e) * 20, dy: (1 - e) * 150 * intensity, scale: 0.82 + 0.18 * e, rotate: side * (1 - e) * 0.38 * intensity, alpha: e, blur: (1 - e) * 3, glow: 0 }
    }
  },
  {
    id: 'zoom-away-out',
    ...
    apply({ enterT, intensity }) {
      const e = clamp01(enterT)
      return { dx: 0, dy: 0, scale: 1 + (1 - e) * 0.9 * intensity, rotate: 0, alpha: e, blur: (1 - e) * 16, glow: (1 - e) * 8 }
    }
  },
  {
    id: 'implode-out',
    ...
    apply({ enterT, intensity }) {
      const e = clamp01(enterT)
      return { dx: 0, dy: 0, scale: Math.max(0.03, 0.04 + 0.96 * e), rotate: (1 - e) * 0.18 * intensity, alpha: e, blur: (1 - e) * 5, glow: (1 - e) * 12 }
    }
  },
  {
    id: 'scatter-out',
    ...
    apply({ enterT, unitIndex, charIndexInUnit, intensity, rand }) {
      ...
      return { dx: rx * (1 - e) * 260 * intensity, dy: ry * (1 - e) * 190 * intensity, scale: 0.45 + 0.55 * e, rotate: rr * (1 - e) * 1.4, alpha: e, blur: (1 - e) * 5, glow: 0 }
    }
  },
  {
    id: 'whip-left-out',
    ...
    apply({ enterT, unitIndex, intensity }) {
      const e = clamp01(enterT)
      return { dx: -(1 - e) * (310 + unitIndex * 18) * intensity, dy: (1 - e) * 12, scale: 0.88 + 0.12 * e, rotate: -(1 - e) * 0.14, alpha: e, blur: (1 - e) * 5, glow: 0, skewX: -(1 - e) * 0.28 }
    }
  },
  {
    id: 'tumble-out',
    ...
    apply({ enterT, unitIndex, charIndexInUnit, intensity }) {
      ...
      return { dx: side * (1 - e) * 52, dy: (1 - e) * 138 * intensity, scale: 0.52 + 0.48 * e, rotate: side * (1 - e) * 1.35 * intensity, alpha: e, blur: (1 - e) * 2, glow: 0 }
    }
  },
  {
    id: 'dissolve-out',
  ...
  },
  {
    ...
    apply({ enterT, unitIndex, charIndexInUnit, intensity, rand }) {
      ...
      return { dx: drift * (1 - e) * 46 * intensity, dy: -(1 - e) * (90 + rand(key + 12) * 100) * intensity, scale: 0.72 + 0.28 * e, rotate: drift * (1 - e) * 0.25, alpha: e, blur: (1 - e) * 13, glow: (1 - e) * 5 }
    }
  },
  {
    id: 'sink-out',
    ...
    apply({ enterT, unitIndex, unitCount, intensity }) {
      ...
      const e = local
      return { dx: 0, dy: (1 - e) * (78 + unitIndex * 8) * intensity, scale: 0.78 + 0.22 * e, rotate: 0, alpha: e, blur: (1 - e) * 6, glow: 0 }
    }
  },
  {
    id: 'blur-out',
  ...
  },
  {
    ...
    apply({ enterT, unitIndex, intensity }) {
      const e = clamp01(enterT)
      const side = unitIndex % 2 === 0 ? -1 : 1
      return { dx: side * (1 - e) * 22 * intensity, dy: 0, scale: Math.max(0.06, 0.05 + 0.95 * e), rotate: side * (1 - e) * 0.08, alpha: e, blur: (1 - e) * 3, glow: 0 }
    }
  },
  {
    id: 'rotate-out',
    ...
    apply({ enterT, intensity }) {
      ...
      return { dx: 0, dy: (1 - e) * -18 * intensity, scale: 0.92 + 0.08 * e, rotate: (1 - e) * 0.24 * intensity, alpha: clamp01(enterT), blur: (1 - e) * 4, glow: 0 }
    }
  },
  {
    id: 'glitch-out',
    ...
    apply({ enterT, unitIndex, charIndexInUnit, intensity, rand }) {
      ...
      return { dx: jitter * 34 * intensity, dy: (rand(key + 1) * 2 - 1) * (1 - e) * 18 * intensity, scale: 0.94 + 0.06 * e, rotate: jitter * 0.1, alpha: e, blur: (1 - e) * 3, glow: 0 }
    }
  },
  {
    id: 'stretch-out',
    ...
    apply({ enterT, intensity }) {
      const e = clamp01(enterT)
      return { dx: 0, dy: 0, scale: 0.7 + 0.3 * e, rotate: 0, alpha: e, blur: (1 - e) * 3, glow: 0, skewX: -(1 - e) * 0.32 * intensity }
    }
  }
]
