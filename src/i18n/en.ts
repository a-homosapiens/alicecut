...
export const en: Record<keyof typeof zh, string> = {
  ...
  'style.effectOutManaged': 'Flip and Rise manage the caption-to-caption transition. Independent Out effects and Out duration are disabled for those caption lines.',
  ...
  'style.effectDurationNoneHint': 'None has no animation, so duration does not apply.',
  ...
  'tl.cantFreeze': 'Playhead is not inside this video clip — cannot freeze the frame.',
  'tl.noAudioStream': 'This video has no audio stream.',
  'tl.splitTitle': 'Split the clip at the red playhead',
  'tl.splitWord': 'Split',
  'tl.freezeTitle': 'Split at the red playhead and insert a three-second freeze of the exact frame',
  'tl.freezeFrame': 'Freeze Frame (3s)',
  'tl.freezeBadge': 'Freeze {n}s',
  'tl.start': 'Start',
  'tl.loop': 'Loop',
  'tl.times': '×',
